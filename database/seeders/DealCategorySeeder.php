    ...
    public function run(): void
    {
        DB::table('deal_categories')->insert([
            [
                ...
                'image_path' => 'assets/images/deal_categories/card_image_1.webp',
                'active' => 1,
            ],
            [
                'name' => 'POPULAR',
                ...
                'image_path' => 'assets/images/deal_categories/card_image_2.webp',
                'active' => 1,
            ],
            [
                'name' => 'EARLY BIRD',
                ...
                'image_path' => 'assets/images/deal_categories/card_image_3.webp',
                'active' => 1,
            ],
            [
                'name' => 'LAST CHANCE',
                ...
                'image_path' => 'assets/images/deal_categories/card_image_4.webp',
                'active' => 1,
            ],
            [
                'name' => 'LIMITED TIME',
                ...
                'image_path' => 'assets/images/deal_categories/card_image_5.webp',
                'active' => 1,
            ]
        ]);
    }
