            ...
            <div class="col-lg-8 col-md-8 col-12">
                <div class="card p-3 mb-3 Regular shadow" style="border: 1px solid #00000012">
                    <div class="d-flex align-items-center">
                        ...
                        @else
                        <button type="button" class="btn primary_new_btn" style="font-size: 12px" data-bs-toggle="modal"
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            @else
                            <p class="font-weight-bold" style="color: #6C6C6C;">Uh-oh! It looks like you don't have a
                                default
                ...
                <div class="card p-3 mb-3" id="product_list">
                    ...
                    try {
                    if (isset($product->delivery_days) && isset($product->created_at)) {
                    $deliveryDays = (int) $product->delivery_days;
                    $deliveryDate =
                    $deliveryDays > 0
