  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="text-center my-4">
        <a href="{{$actionUrl}}"><button class="btn btn-primary btn-sm reset_btn" type="button">
            Reset Password
          </button></a>
      </div>
      <p>
      ...
      <p class="mt-3">
        ...
        and paste the URL below into your web browser: <a href="{{$displayableActionUrl}}">{{$actionUrl}}</a>
      </p>
    </div>
