            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-3 text-md-start text-center mb-4 mb-md-0">
                    ...
                    <div class="social-icons">
                        ...
                        <a href="https://www.youtube.com/channel/UCIbNIWhaDnRs-gFuJ0sTNCQ/videos"
                            class="text-decoration-none me-2"><i class="fab fa-youtube" style="font-size: 15px"></i></a>
                        <a href="#" class="text-decoration-none me-2"><i class="fab fa-whatsapp"
                                style="font-size: 15px"></i></a>
                        <a href="https://x.com/ecscloudinfote2" class="text-decoration-none"><i class="fab fa-x-twitter"
                                style="font-size: 15px"></i></a>
                    </div>
                </div>
                <!-- Footer Columns -->
                ...
                <div class="col-md-3 col-12 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="{{ url('/') }}" class="text-light text-decoration-none">Beauty</a>
                        </li>
                        <li>
                            <a href="{{ url('/') }}" class="text-light text-decoration-none">Massage</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ url('/') }}" class="text-light text-decoration-none">Health Care</a>
                        </li>
                        <li>
                            <a href="{{ url('/') }}" class="text-light text-decoration-none">Travel</a>
                        </li>
                        <li>
                            <a href="{{ url('/') }}" class="text-light text-decoration-none">Logistics</a>
                        </li>
                        <li>
                            <a href="{{ url('/') }}" class="text-light text-decoration-none">Services</a>
                        </li>
                    </ul>
                </div>
