    ...
    <nav id="NavBar" class="navbar mainNav fixed-top navbar-expand-xl navbar-light"
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center mb-1">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="{{ url('/wishlist') }}" class="text-decoration-none d-xl-none p-2"
                    style="text-decoration: none;">
                    <i class="fa-regular fa-bookmark fa-xl" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        title="Wishlist" style="color: #ff0060;"></i>
                </a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <a href="{{ url('/wishlist') }}" class="text-decoration-none p-2 d-none d-xl-inline"
                    style="text-decoration: none;">
                    <i class="fa-regular fa-bookmark fa-xl" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        title="Wishlist" style="color: #ff0060;"></i>
                </a>
