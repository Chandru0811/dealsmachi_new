...
<div class="alert alert-dismissible fade show" role="alert"
    style="position: fixed; top: 70px; right: 40px; z-index: 1050; background:#ff0060; color:#fff">
    {{ session('error') }}
    <button type="button" class="btn-close btn-sm" style="" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
@endif
@php
$reviewData = [
...
'review' => 'Thank you Trucklah for the wonderful job. I am very much happy with your service. I got track updates
regularly and
...
'review' => 'Thank you Trucklah for your prompt service. We were in difficulty with lack of space in our apartment.
Thankfully,
Trucklah managed it well and were on time and budget friendly.',
'rating' => 5,
...
'review' => 'I did an item move last week with Trucklah. The service was excellent. I recommend their service, they are
professional
in approach.',
'rating' => 4,
...
[
'reviewerName' => 'Leela',
'review' => 'Trucklah helped us to move our office last week. Their service was really appreciable. The best thing I
noted is that
they were professional in approach and they did really well to relocate our office. I am really thankful for their
effort!',
'rating' => 5,
...
[
'reviewerName' => 'Suriya',
'review' => 'We were in a hurry and there was no one we trust. Thanks to Trucklah, for helping us on time like a friend.
Their
delivery experts handled everything without errors.',
'rating' => 5,
...
'review' => 'As a business, we never rely much on third party services. But Trucklah changed us. We are full partnership
with
Trucklah now. Complete peace of mind.',
'rating' => 5,
...
'review' => 'E-commerce is tricky. But if you have a logistics partner like Trucklah, life is more easy than we expect.
Timely
delivery, on schedule, all the time.',
'rating' => 4,
...
'review' => 'We never thought moving would be this easy. Not until we had our move scheduled with Trucklah. App booking,
online
...
[
'reviewerName' => 'Manoj',
'review' => 'Space issues were too much for us. Until Trucklah cleared it for us without any headaches. For any moving
work, I
recommend Trucklah.',
'rating' => 4,
...
[
'reviewerName' => 'Siva',
'review' => 'Moving is not easy in India. But with Trucklah by your side, nothing is impossible. Faster, reliable and
safe delivery
from Trucklah has changed the scene.',
'rating' => 5,
            ...
            <div class="row m-0 p-2">
                <div class="col-md-6 column">
                    <div class="row m-0" style="position:sticky; top:100px">
                        ...
                        @endphp
                        <div class="col-md-2 col-3 pe-md-0 image_slider_vw">
                            @if ($hasMedia)
                            <div class="text-center arrow-button mb-2">
                                <button type="button" style="border:none; background-color: #eaeaea" id="scrollUpBtn"
                                    title="Scroll up" aria-label="Scroll up" onclick="scrollUp()">
                            ...
                            <div class="text-center arrow-button mt-2">
                                <button type="button" style="border:none; background-color: #eaeaea" id="scrollDownBtn"
                                    title="Scroll down" aria-label="Scroll down" onclick="scrollDown()">
                ...
                <div class="col-md-6 ps-4 mt-3 space_ctrl column">
                    ...
                    <div>
                        ...
                        <div class="price-section mt-4 d-flex">
                            ...
                            <p>
                                <span id="mySpan" class="deal-badge" style="cursor: pointer; position:relative;-"
                                    onclick="copySpan(this, event)" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    title="Click to Copy">
                        ...
                        <div class="description-section mt-4">
                            ...
                            <div class="mt-2" style="border: 1px solid #c1bcbc40;border-radius:5px; width: fit-content">
                                <div class="row m-0">
                        ...
                        <div class="seller-information mt-4">
                            ...
                            <div class="card_offers">
                                <div class="d-flex justify-content-end align-items-end text-center my-2">
                                    <a href="#" class="modal_links" data-bs-toggle="modal" data-bs-target="#aboutModal">
                                        <span>About</span>
                                    </a>&nbsp;&nbsp;
                ...
                <div class="col-12 ">
                    ...
                    <div class="p-3 position-relative card py-5">
                        <div class="owl-carousel carousel_content owl-theme image-slider1 d-flex gap-3 overflow-hidden carousel-container"
                            ...
                            <img src="https://img.youtube.com/vi/{{ $videoId }}/0.jpg"
                                alt="Video Thumbnail {{ $video->order }}" class="img-fluid item" data-bs-toggle="modal"
                                data-bs-target="#videoModal" onclick="updateVideoModal('{{ $videoId }}')">
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="card_offers review_section p-3">
                    ...
                    <div class="rating-summary mb-4">
                        <div class="d-flex align-items-center">
                            <h5>Total score :</h5> &nbsp;&nbsp;<h2 class="average-rating me-2" style="color:#40d128">
                                {{ $averageRating }}
                        ...
                        <p class="ms-2">No. of reviews : &nbsp;&nbsp;<span style="color: #c0b9b9;">{{ $totalReviews }}
                                Reviews</span></p>
                    </div>
                    ...
                    @else
                    <!-- Empty State -->
                    <div class="no-reviews d-flex justify-content-center align-items-center" style="min-height: 200px;">
