                    ...
                    <div class="row">
                      <div class="col-md-6 col-12 px-5">
                        ...
                        <form id="contactForm">
                          ...
                          <div class="mb-5">
                            <label for="description_info" class="form-label text-muted"
                              >Leave your Message</label
                            >
                            <textarea
                              class="form-control input-text-color"
                              style="box-shadow: none"
                              id="description_info"
                      ...
                      <div class="borderline col-md-6 col-12 px-5">
                        ...
                        <ul class="nav nav-tabs">
                          <li class="nav-item">
                            <a
                              class="nav-link contact-nav  active"
                              id="singapore-tab"
                              onclick="showAddress('singapore')"
                              href="javascript:void(0);"
                            >
                              <img
                               src="{{ asset('assets/images/contactus/Flag_of_Singapore.webp') }}"
                                alt="singapore_flag"
                                class="shadow  m-2 mx-4"
                          ...
                          <li class="nav-item  contact-nav">
                            <a
                              class="nav-link"
                              id="india-tab"
                              onclick="showAddress('india')"
                              href="javascript:void(0);"
                            >
                              <img
                               src="{{ asset('assets/images/contactus/India Flag.webp') }}"
                                alt="india_flag"
                                class="shadow  m-2 mx-4"
                                style="width: 40px; height: 30px"
                              />
                        ...
                        <a
                         id="phone-link"
                          href="tel:88941306"
                          class="contact-subheading text-muted text-decoration-none d-flex"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                        ...
                        >
                          ...
                          <p><b>info@ecsaio.com</b></p>
                        </a>
                        <br /><br />
                        <div class="d-flex flex-wrap my-2 socialicons">
                          <a
                            href="https://sg.linkedin.com/company/ecs-cloud-infotech"
                          ...
                          <a
                            href="https://www.facebook.com/ecscloud/"
                            class="p-1 text-decoration-none text-white"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            <span
                              class="mediaIconBgIcon d-flex justify-content-center align-items-center"
                            >
