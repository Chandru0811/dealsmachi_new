                            ...
                            <div class="card sub_topCard h-100 d-flex flex-column">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <div class="ps-3">
                                            <p>Regular Price</p>
                                            <p><s class="original-price">{{ $product->original_price }}</s></p>
                                        </div>
                                        <div class="card-divider"></div>
            ...
            <div class="col-md-12 col-lg-2 col-12 mb-3">
                <div class="card p-2 d-flex justify-content-center align-items-center" style="border-radius: 10px;border: none">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 p-1">
                            <div class="card h-100 prodFilterCard" style="border-color: #cc2366; border-radius: 10px;">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 p-1">
                            <div class="card h-100 prodFilterCard" style="border-color: #FF0000; border-radius: 10px;">
                        ...
                        <div class="col-6 p-1">
                            <div class="card h-100 prodFilterCard" style="border-color: #25D366; border-radius: 10px;">
