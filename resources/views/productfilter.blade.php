...
<head>
    ...
    @section('head_links')
        ...
        <link rel="canonical" href="https://dealslah.com/productfilter" />
                                    ...
                                    <div class="card-body card_section">
                                        <div class="mt-3 d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="badge mx-3 p-0 trending-wishlist-badge"><i
                                                    class="fa-regular fa-bookmark wishlist-icon"
                                                    onclick="toggleBookmark(this)"></i></span>
                                        </div>
                                        <span class="px-3">
                                    ...
                                    <div class="card-body card_section">
                                        <div class="mt-3 d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="badge p-0 mx-3 trending-wishlist-badge"><i
                                                    class="fa-regular fa-bookmark wishlist-icon"onclick="toggleBookmark(this)"></i></span>
                                        </div>
                                        <span class="px-3">
                                            <i class="fa-solid fa-star" style="color: #ffc200"></i>
                                            <i class="fa-solid fa-star" style="color: #ffc200"></i>
