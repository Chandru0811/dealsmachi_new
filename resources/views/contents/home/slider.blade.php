<div class="container slider-content">
    <div class="row">
        ...
        <div class="col-md-12 col-lg-3 col-12 pt-2">
            <div class="card py-1 px-1" style="border-radius: 10px;width: 100%;">
                <div class="d-flex">
                    ...
                    <div class="card"
                        style="border-radius: 10px;width: 49%; border-color: #cc236; overflow: hidden;">
                ...
                <div class="d-flex mt-1">
                    <div class="card me-1"
                        ...
                        <a href="https://www.youtube.com/channel/UCIbNIWhaDnRs-gFuJ0sTNCQ/videos" target="_blank"
                            style="text-decoration:none;">
                            <div class="d-flex justify-content-center align-items-center  p-1">
